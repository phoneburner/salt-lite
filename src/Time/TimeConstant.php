 ...
 */
readonly final class TimeConstant
{
    ...
    public const int SECONDS_IN_DAY = self::HOURS_IN_DAY * self::SECONDS_IN_HOUR;
    public const int MIN_SECONDS_IN_DAY = self::SECONDS_IN_DAY - 1;
    public const int MAX_SECONDS_IN_DAY = self::SECONDS_IN_DAY + 1;
    ...
    public const int MIN_SECONDS_IN_YEAR = self::SECONDS_IN_HOUR * self::HOURS_IN_DAY * self::MIN_DAYS_IN_YEAR;
    public const int MAX_SECONDS_IN_YEAR = self::SECONDS_IN_HOUR * self::HOURS_IN_DAY * self::MAX_DAYS_IN_YEAR;
    public const int MIN_MINUTES_IN_YEAR = self::MINUTES_IN_DAY * self::MIN_DAYS_IN_YEAR;
    public const int MAX_MINUTES_IN_YEAR = self::MINUTES_IN_DAY * self::MAX_DAYS_IN_YEAR;

    public const int SECONDS_IN_WEEK = self::SECONDS_IN_HOUR * self::HOURS_IN_DAY * self::DAYS_IN_WEEK;
}
