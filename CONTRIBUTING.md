...
project's [GitHub Issues page](https://github.com/phoneburner/salt-lite/issues).
...
### Coding Style
`phoneburner/salt-lite` follows a superset of **[PER Coding Style 2.0][per-cs]**, 
...
* Please **ensure that tests pass** before submitting your pull request.
  `phoneburner/salt-lite` automatically runs tests for pull requests. However,
